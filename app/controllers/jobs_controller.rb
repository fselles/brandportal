class JobsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @job.save
        format.html { redirect_to @job, notice: 'Job is succesvol opgeslagen.' }
  ...
  def destroy
    @job.destroy
    respond_to do |format|
      format.html { redirect_to jobs_url, notice: 'Job is verwijderd.' }
  ...
  private
    ...
    def job_params
      params.require(:job).permit(:contactperson, :title, :description, :article_number, :status)
    end
end
